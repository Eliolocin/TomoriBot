export default {
  respond: {
    ...
    embed_hide_notice: `\`/config\` > Behavior > Notices でこの埋め込みを非表示にできます。`,
    use_reasoning_label: `推論を使用`,
    use_reasoning_description: `利用可能な最も賢いモデルを使用して高度な推論モードを切り替えます。`,
    no_smart_model_title: `推論モデルが見つかりません`,
    no_smart_model_description: `現在のAIプロバイダーに推論モデルが見つかりませんでした。\`/config\` > Models > Switch Modelsを使用して、推論モデルをサポートするプロバイダーに切り替えてください。`,
