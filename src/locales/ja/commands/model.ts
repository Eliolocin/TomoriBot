export default {
  model: {
    ...
    speech: {
      ...
      no_endpoints_description: `まず \`/providers\` または \`/providers\` で音声エンドポイントを登録してください。`,
    ...
    transcription: {
      ...
      no_endpoints_description: `まず \`/providers\` または \`/providers\` で文字起こしエンドポイントを登録してください。`,
...
**検出された機能:** {capabilities}`,
    ...
    embedding: {
      ...
      no_api_key_description: `埋め込みモデルを変更するには保存済みプロバイダーが必要です。先に \`/providers\` を使用してください。`,
    ...
    fallback: {
      ...
      no_providers_description: `このサーバーにはテキストプロバイダーが設定されていません。先に \`/providers\` を使用してください。`,
...
{model_list}`,
    ...
    image: {
      ...
      no_api_key_title: `APIキーが設定されていません`,
      no_api_key_description: `画像モデルを変更するには保存済みプロバイダーが必要です。先に \`/providers\` を使用してください。`,
    ...
    video: {
      ...
      no_api_key_title: `APIキーが設定されていません`,
      no_api_key_description: `動画モデルを変更するには保存済みプロバイダーが必要です。先に \`/providers\` を使用してください。`,
    ...
    vision: {
      ...
      no_api_key_description: `ビジョンモデルを設定するには保存済みプロバイダーが必要です。先に \`/providers\` を使用してください。`,
...
{removed_overrides}`,
    ...
    parameters: {
      ...
      provider_not_saved_description: `**{provider}** の保存済み設定がありません。先に \`/providers\` で追加してください。`,
