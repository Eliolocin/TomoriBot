export default {
  impersonate: {
    ...
    persona_impersonation_notice_description: `\`/config\` > Behavior > Notices でこの埋め込みを非表示にできます。`,
    persona_impersonation_notice_footer: `{user}によるなりすまし`,
    user_impersonation_notice_description: `\`/config\` > Behavior > Notices でこの埋め込みを非表示にできます。あなたをどうなりすますか教えるには、\`/personal config\` を設定してください。`,
