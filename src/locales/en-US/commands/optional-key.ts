...
⚠️ **Important:** Brave provides $5 in free monthly credits wherein usage beyond that is billed. To avoid unexpected charges, set a $5 usage limit in your [Brave usage limits dashboard](https://api-dashboard.search.brave.com/app/subscriptions/usage-limits).`,
    ...
    elevenlabs: {
      ...
      set: {
        ...
        success_voices_description: `Premade voices work on the free plan. Browse the full list at [ElevenLabs Premade Voices](https://elevenlabs-sdk.mintlify.app/voices/premade-voices), then use /config under Persona > Voice to assign one to each persona.`,
        success_custom_voices_title: `Library & Custom Voices (Paid)`,
        success_custom_voices_description: `Library voices and custom/cloned voices both require a paid ElevenLabs plan. Once added to your account, they will appear automatically in /config under Persona > Voice.`,
