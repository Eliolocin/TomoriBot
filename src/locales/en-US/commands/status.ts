export default {
  status: {
    ...
    server_page10_title: `Server Status: Advanced Toggles`,
    server_page10_description: `Display, debugging, uncensoring, and tool toggles`,
    ...
    field_preview_clipped: `Preview clipped to fit Discord embed limits.`,
