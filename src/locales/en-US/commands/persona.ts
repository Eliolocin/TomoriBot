...
-# {details}`,
    ...
    "naming-habits": {
      description: `Configure how a persona formats and addresses user names.`,
      style_description: `The naming variant to edit.`,
      masculine_option: `Masculine`,
      feminine_option: `Feminine`,
      neutral_option: `Neutral`,
      modal_title: `Persona Naming Habits`,
      prefix_label: `Name prefix`,
      prefix_description: `Placed before the effective nickname. Blank clears this variant.`,
      suffix_label: `Name suffix`,
      suffix_description: `Placed after the effective nickname. Blank clears this variant.`,
      address_term_label: `Standalone address term`,
      address_term_description: `Replaces {user_term} in persona-authored text; it is not appended to names.`,
      neutral_required_title: `Neutral Address Term Required`,
      neutral_required_description: `Configure a non-empty neutral address term before adding gendered terms or using {user_term}.`,
      no_permission_title: `Permission Required`,
      no_permission_description: `You need Manage Server permission to edit persona naming habits.`,
      success_title: `Naming Habits Updated`,
      success_description: `Updated **{persona}**'s **{style}** naming variant. The persona was materialized first if it referenced an official preset.`,
    },
  },
};
