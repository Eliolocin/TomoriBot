export default {
  generate: {
    ...
    image: {
      ...
      api_key_decrypt_failed_description: `Failed to decrypt the configured image provider credentials. Please reconfigure them using \`/providers\`.`,
...
**Prompt:** {prompt}`,
      ...
      api_key_decrypt_failed_title: `🔴 API Key Error`,
      api_key_decrypt_failed_description: `Failed to decrypt the configured video provider credentials. Please reconfigure them using \`/providers\`.`,
