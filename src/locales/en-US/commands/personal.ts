...
You can change this anytime using \`/personal privacy\`.`,
    ...
    nickname: {
      ...
      nickname_description: `Leave blank to use your live Discord name.`,
      prefix_mode_label: `Prefix behavior`,
      suffix_mode_label: `Suffix behavior`,
      prefix_label: `Custom prefix`,
      suffix_label: `Custom suffix`,
      affix_text_description: `Used only when Custom is selected.`,
      inherit_option: `Inherit`,
      inherit_description: `Continue to the next global or persona default.`,
      none_option: `None`,
      none_description: `Explicitly suppress inherited values.`,
      custom_option: `Custom`,
      custom_description: `Use the non-empty text entered below.`,
      invalid_affix_title: `Custom Value Required`,
      invalid_affix_description: `Enter non-empty text for every affix whose mode is Custom.`,
...
**Warning:** Personalization is currently disabled on this server, so I won't use this nickname here. I'll still use it on other servers where personalization is enabled.`,
    ...
    identity: {
      description: `Set your optional identity and preferred style of address.`,
      modal_title: `Personal Identity`,
      ...
      orientation_description: `Optional profile context. Leave blank to clear.`,
      style_label: `Preferred addressing style`,
      style_description: `Selects a persona's naming variant; it is not inferred from identity.`,
      style_unspecified: `Unspecified`,
      style_masculine: `Masculine`,
      style_feminine: `Feminine`,
      style_neutral: `Neutral`,
      success_title: `Identity Settings Updated`,
      success_description: `Your identity and addressing preferences were updated. Empty fields were cleared.`,
    },
    impersonate: {
