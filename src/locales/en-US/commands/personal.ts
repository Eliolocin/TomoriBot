...
These samplers apply to your own requests in every server. This server's samplers are unchanged.`,
    ...
    config: {
      ...
      persona_naming_description: `Override how one persona addresses you. Empty fields inherit your global profile or the persona's defaults.`,
      persona_select_placeholder: `Select a persona...`,
      persona_default_name: `Persona`,
      persona_main_description: `Main persona`,
      persona_alter_description: `Alter persona`,
      ...
      crossserver_stm_off: `I **cannot** remember recent conversations with you across servers because Cross-server STM is off.`,
      crossserver_stm_on: `I **can** remember recent conversations with you across servers because Cross-server STM is on.`,
...
A capability set to Server Default uses the current server's models instead.`,
      ...
      models_stub_title: `Models`,
      models_stub_description: `This section is not available yet.`,
      advanced_stub_title: `Advanced`,
      advanced_stub_description: `This section is not available yet.`,
      cancel: `Cancel`,
      retry: `Retry`,
      stale_warning: `This panel may be out of date. Click Retry to refresh.`,
