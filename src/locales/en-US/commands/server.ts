...
**Roles:** {roles_removed}`,
    ...
    cooldown: {
      ...
      triggers: {
        description: `Set cooldown type and duration for triggers and manual commands (defaults: off, 5s).`,
        ...
        success_description: `Cooldown updated from **{previous_type}**, **{previous_length}** seconds to **{type}**, **{length}** seconds. This applies to both message triggers and manual commands.`,
        success_disabled_title: `Cooldowns Disabled`,
        success_disabled_description: `Cooldown updated from **{previous_type}**, **{previous_length}** seconds to **{type}**, **{length}** seconds. Message trigger and manual command cooldowns are now disabled.`,
        type: {
          choice_off: `Off`,
