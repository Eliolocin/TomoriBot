export default {
  forget: {
    sampledialogue: {
      ...
      no_dialogues: `There are no sample dialogues stored to remove. Add some with \`/config\` > Persona > General.`,
    ...
    attribute: {
      ...
      no_attributes: `There are no personality attributes to remove. Add some with \`/config\` > Persona > General.`,
    ...
    document: {
      ...
      none_description: `There are no documents to remove in this scope. Add one with \`/memories\`.`,
...
**Warning:** Personalization is currently disabled on this server, so this change won't affect my behavior here. It will still be reflected on other servers where personalization is enabled.`,
      ...
      server: {
        ...
        no_memories: `There are no server memories stored for this server. Add some with \`/memories\`.`,
