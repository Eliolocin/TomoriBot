export default {
  ...
  model: {
    ...
    speech: {
      ...
      no_endpoints_description: `Register a speech endpoint first with \`/providers\` or \`/providers\`.`,
    ...
    transcription: {
      ...
      no_endpoints_description: `Register a transcription endpoint first with \`/providers\` or \`/providers\`.`,
...
**Detected Capabilities:** {capabilities}`,
    ...
    embedding: {
      ...
      no_api_key_description: `A saved provider is required before changing embedding models. Please use \`/providers\` first.`,
    ...
    fallback: {
      ...
      no_providers_description: `No text providers are configured for this server. Use \`/providers\` to set one up first.`,
...
{model_list}`,
    ...
    image: {
      ...
      no_api_key_title: `No API Key Set`,
      no_api_key_description: `A saved provider is required before changing image models. Please use \`/providers\` first.`,
    ...
    video: {
      ...
      no_api_key_title: `No API Key Set`,
      no_api_key_description: `A saved provider is required before changing video models. Please use \`/providers\` first.`,
    ...
    vision: {
      ...
      no_api_key_title: `No API Key Set`,
      no_api_key_description: `A saved provider is required before setting a vision model. Please use \`/providers\` first.`,
...
{removed_overrides}`,
    ...
    parameters: {
      ...
      provider_not_saved_description: `No saved configuration exists for **{provider}**. Add it first with \`/providers\`.`,
