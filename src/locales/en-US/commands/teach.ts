export default {
  teach: {
    sampledialogue: {
      ...
      limit_exceeded_description: `This server has reached its sample dialogue limit of {max_allowed} dialogues (currently has {current_count}). Please remove some sample dialogues with \`/config\` > Persona > General before adding new ones.`,
...
> {bot_input}`,
    ...
    attribute: {
      ...
      limit_exceeded_description: `This server has reached its attribute limit of {max_allowed} attributes (currently has {current_count}). Please remove some attributes with \`/config\` > Persona > General before adding new ones.`,
      batch_limit_exceeded_title: `Batch Import Exceeds Limit`,
    ...
    document: {
      ...
      no_embedding_model_description: `An embedding model is not configured for this provider. Please set one using \`/config\` > Models > Switch Models.`,
...
**Warning:** You are currently blacklisted from personalization features on this server, so these memories won't be used here. They will still be available on other servers where you are not blacklisted.`,
      ...
      server: {
        ...
        limit_exceeded_description: `This server has reached its memory limit of {max_allowed} memories (currently has {current_count}). Please remove some memories with \`/memories\` before adding new ones.`,
        batch_limit_exceeded_title: `Batch Import Exceeds Limit`,
        batch_limit_exceeded_description: `Import needs {import_count} slots, but only {max_allowed} total ({current_count} used). Remove {remove_count} memories and try again.`,
        content_too_long_title: `Memory Content Too Long`,
        content_too_long_description: `The memory content is too long. Maximum allowed length is {max_length} characters.`,
