...
{failure_list}`,
    ...
    tips: {
      ...
      openrouter_models: `Browse the [OpenRouter model list](https://openrouter.ai/models), register a model with \`/providers\`, then switch with \`/model text\`.`,
      openrouter_models_personal: `Browse the [OpenRouter model list](https://openrouter.ai/models), register a model with \`/personal providers\`, then switch with \`/personal provider model-text\`.`,
      ...
      switch_model_provider: `Switch to a different model or provider with \`/model text\` or \`/providers\`.`,
      switch_model_provider_personal: `Switch with \`/personal provider model-text\`, or update the provider in \`/personal providers\`.`,
      disable_personal_text_override: `This request error was from your [personal provider](https://docs.tomoribot.app/en/features/knowledge/personalization/#your-own-providers). Update it in \`/personal providers\` or select a working model with \`/personal provider model-text\`.`,
