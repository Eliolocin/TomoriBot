...
<CardGrid>
  <LinkCard title="Text-to-Speech" href="/self-hosting/local-endpoints/text-to-speech/"
    description="Local TTS engines (Chatterbox, Qwen3-TTS, IrodoriTTS, CosyVoice 3) for native Discord voice messages with voice cloning." />
...
Available flags: `--searxng`, `--crawl4ai`, `--qwen3tts`, `--chatterbox`, `--irodoritts`, `--cosyvoice3`, `--whisperx`
