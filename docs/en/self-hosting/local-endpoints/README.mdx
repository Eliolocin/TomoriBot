...
<CardGrid>
  <LinkCard title="Text-to-Speech" href="/self-hosting/local-endpoints/text-to-speech/"
    description="Local TTS engines (Chatterbox, Qwen3-TTS, IrodoriTTS, Fish S2 Pro, VoxCPM2) for native Discord voice messages, voice cloning, and VoiceDesign." />
...
Available flags: `--searxng`, `--crawl4ai`, `--qwen3tts`, `--chatterbox`, `--irodoritts`, `--voxcpm2`, `--fishs2`, `--whisperx`
