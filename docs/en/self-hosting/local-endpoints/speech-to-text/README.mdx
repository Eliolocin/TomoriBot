...
3. Select the saved endpoint, choose **Add or Edit a Model**, and add the model code reported by the server.
4. Use `/model transcription` later only when switching between registered STT endpoints.
